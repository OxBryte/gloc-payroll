  ...
  "data": [
    {
      ...
      "title": "string",
      "description": "string",
      "status": "string (pending, ongoing, completed, archived)",
...
```json
{
  ...
  "status": "string (optional) - Default: 'pending'. Values: 'pending', 'ongoing', 'completed', 'archived'",
...
```json
{
  ...
  "description": "string (optional)",
  "status": "string (optional) - Values: 'pending', 'ongoing', 'completed', 'archived'",
...
```javascript
{
  ...
  status: String (optional, default: "pending", enum: ["pending", "ongoing", "completed", "archived"]),
