    ...
    <div className="min-h-screen w-full relative">
      ...
      <div className="mt-10 w-full max-w-[480px] mx-auto relative space-y-6">
        ...
        <div className="w-full space-y-4">
          ...
          <div className="w-full bg-white rounded-[20px] border border-gray-100 p-4 flex items-center justify-center gap-3 cursor-pointer hover:bg-gray-50 hover:scale-98 transition-all duration-300">
            <HiOutlinePlus size={20} className="" />
            <p>Create New Wallet</p>
          </div>
        </div>
