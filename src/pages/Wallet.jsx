  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <div className="mt-10 w-full max-w-[480px] mx-auto relative space-y-6">
        ...
        {/* New Wallet */}
        <div className="w-full h-full bg-c-color text-white rounded-[20px] p-4 flex items-center justify-center gap-3 cursor-pointer hover:bg-c-color/80 scale-95 transition-all duration-300">
