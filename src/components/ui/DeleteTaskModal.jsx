      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="flex justify-end gap-3 p-5 border-t border-gray-200">
          ...
          <button
            ...
            disabled={isPending}
            className="text-sm px-6 py-2.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors font-medium disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
          >
