export const pocketContractAddress = "0x451d13908B0C8bfA8492f4bf5f2b34fC2a82edF9";

export const pocketContractABI = [
  {
    inputs: [
  ...
  },
  {
    ...
    name: "allocateToCategory",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [{ internalType: "string", name: "_categoryName", type: "string" }],
    name: "createCategory",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "emergencyWithdrawWrongToken",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
