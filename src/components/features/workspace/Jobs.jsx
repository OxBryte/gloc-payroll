...
export default function Jobs() {
  return (
    <div className="w-full space-y-5">
      <div className="w-full bg-gradient-to-r from-c-color via-black to-c-color-sec rounded-lg p-10 space-y-2">
        <h1 className="font-bold text-white text-[24px]">
          {" "}
          Here is a Job Board for your Project
        </h1>
        <p className="text-white">Connect your software with the curring-edge technology.</p>
